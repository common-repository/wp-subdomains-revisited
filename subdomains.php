...
Plugin URI: https://wordpress.org/plugins/wp-subdomains-revisited/
Description: Setup your main categories, pages, and authors as subdomains and give them custom themes. Surely will come for more... (OTHER MUST-HAVE PLUGINS : http://codesphpjs.blogspot.com/2014/10/must-have-wordpress-plugins.html )
Version: 0.9.3 
Author: Alex & Erick (IGITS) [ http://www.lontongcorp.com/ + http://casualgenius.com ]
...
class WpsPlugin {
	...
	function WpsPlugin() {
	  ...
	  load_plugin_textdomain( 'wps', false, dirname(WPS_BASE).'/languages/' );
